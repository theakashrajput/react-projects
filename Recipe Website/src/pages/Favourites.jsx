...
const Favourites = () => {
  ...
  return (
    <div className="w-full min-h-screen px-2 sm:px-4 md:px-10 md:pt-28 pt-20">
      {favouriteRecipes.length > 0 ? (
        <>
          <h2 className="text-center mb-4 md:mb-2 text-2xl leading-none">My Favourites ❤️</h2>
        ...
        <div className="w-full text-center text-3xl">No Favourite</div>
      )}
    </div>
  );
};
